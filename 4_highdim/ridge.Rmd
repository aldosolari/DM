...
3. Compare the LOOCV estimate of error for the linear model and the ridge regression model with $\lambda=5$.  
...
cat("LOOCV lm: ", cv.glm(train.std, glm(y ~ 0 + ., train.std, family = gaussian) )$delta[1])
cat("LOOCV ridge with lambda=10: ", mean(LOOCV))
```
