...
$$\mathrm{MSE}^{\mathrm{stack}}_{\mathrm{Tr}} = \frac{1}{m}\sum_{i=1}^{m} (y^*_i - \hat{f}_{\mathrm{stack}}(x^*_i) )^2$$ and compare with
$$\mathrm{MSE}^l_{\mathrm{Tr}} = \frac{1}{m}\sum_{i=1}^{m} (y^*_i - \hat{f}_{l}(x^*_i) )^2, \quad l=1,\ldots,L.$$
