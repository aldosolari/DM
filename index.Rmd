...
* Gli studenti che devono sostenere l'esame nelle sessioni di Giugno/Luglio e Settembre e che non hanno svolto le competizioni sono pregati di contattare il docente via e-mail

* Calendario esami: 5 Luglio LAB719 h 14:00; 16 Luglio LAB713 h 14:00; 18 Settembre LAB713 14:00
...
|  |  |  |  | | |
| 14 | November 12 | Orange data | -  | [Slides](docs/slides/14_Orange/14_Orange_slides.html) |
| 15 | November 15 | [Quiz](https://docs.google.com/forms/d/e/1FAIpQLSeAeV1fJlrxoBZZtmcye-NCeQDzGjpw7VT9vGB8Eb9RmaPDUQ/viewform?usp=sf_link) and [programming exercize](https://aldosolari.github.io/DM/exams/exercize_text.pdf)  | - | - |
| 16 | November 16 | Competitions results and discussion | - | [Slides](docs/slides/16_Github/16_Github_slides.html) |
...
- [Rosset and Tibshirani (2018) ArXiv](https://arxiv.org/pdf/1704.08160.pdf) (optional)
...
**November 12** Orange data

**November 15** Quiz and programming exercise

**November 16** Competitions results and discussion
...
There are three rounds (time windows) for joining the competitions:

| Competition | 1st: From-To | 2nd: From-To | 3rd: From-To | 
|----|----|----|----|
| [Houses prices](docs/competitions/Houseprices/Houseprices.html) | 8/10/18 - 16/11/18 | 28/1/19 - 5/2/19 | 24/6/19 - 28/6/19  |
| [OkCupid](docs/competitions/OkCupid/OkCupid.html)  | 16/10/18 - 16/11/18 | 28/1/19 - 5/2/19 | 24/6/19 - 28/6/19  |
| [Bikesharing](docs/competitions/Bikesharing/Bikesharing.html) | 16/10/18 - 16/11/18 | 28/1/19 - 5/2/19  | 24/6/19 - 28/6/19  |


If a student does not take part in the competitions in the above time windows, he/she must take the __oral exam__ and send via e-mail his/her predictions along with the (reproducible) R code at least one week before the exam.
...
and the following short introduction
...
* you are encouraged to use online resources (unseen models, other people analyses, etc.) as long as you __cite__ a resource you borrow code from. Blind copy/paste from other people code will have a multiplier of 0  

* you are expected to be able to __explain your code by your self__ if required by the teacher

Example of how to create the file to be published on-line containing the code used to get the final prediction: [.Rmd](docs/competitions/publish_example.Rmd) and [.html](docs/competitions/publish_example.html) 


### 1st round

* [List of participants](docs/competitions/Participants.html)

* [Results](docs/competitions/Competitions1_points.html) 

| Competition | Partial | Final | Points |
|----|----|----|----|
| House prices | [partial](docs/competitions/Houseprices/Houseprices_partial1.html) | [final](docs/competitions/Houseprices/Houseprices_final1.html)  | [points](docs/competitions/Houseprices/Houseprices_points1.html) |
| Bikesharing  | [partial](docs/competitions/Bikesharing/Bikesharing_partial1.html) | [final](docs/competitions/Bikesharing/Bikesharing_final1.html) | [points](docs/competitions/Bikesharing/Bikesharing_points1.html) |
| OkCupid | [partial](docs/competitions/OkCupid/OkCupid_partial1.html) | [final](docs/competitions/OkCupid/OkCupid_final1.html) | [points](docs/competitions/OkCupid/OkCupid_points1.html) |
...
| N.ro |When | Where | Hours |
|---|---|---|---|---|
| 1 | 23/11/2018 | LAB713 | 14:00 | 
| 2 | 7/2/2019 | LAB713 | 14:00 | 
| 3 | 22/2/2019 | LAB713 | 8:30 | 
| 4 | 5/7/2019 | LAB719 | 14:00 |
| 5 | 16/7/2019 | LAB713 | 14:00 |
| 6 | 18/9/2019 | LAB713 | 14:00 |

The **Test** consists of

* answering to multiple-choice/open **questions** about theory
* solving **programming exercises** with R 

Some of the questions and/or programming exercises may be taken 
from the book ISLR. For the programming exercises, the following R code will be available in the "TESTO" folder:

* [Code from ISLR](https://aldosolari.github.io/DM/exams/codeISLR.pdf)
* [Code from the lectures](https://aldosolari.github.io/DM/exams/codeNOTES.pdf)

In the "TESTO" folder, you will also find 

* PDF file with the description of the exercises (see [example](https://aldosolari.github.io/DM/exams/example_text.pdf))
* RMarkdown file (see [example](https://aldosolari.github.io/DM/exams/example.Rmd))

In the RMarkdown file you have to write the R code solving the exercises. Then use the **Knit** button to generate an HTML file containing the answers, which will be uploaded to the "CONSEGNA" folder (see [example](https://aldosolari.github.io/DM/exams/example_solution.html)). Other formats will not be accepted. 

Past exams:

* 23/11/2018: [Text](https://aldosolari.github.io/DM/exams/DM231118/DM231118_text.pdf) - [Solution](https://aldosolari.github.io/DM/exams/DM231118/DM231118_solution.html) - [Marks](https://aldosolari.github.io/DM/exams/DM231118/DM231118_esiti.pdf)


* 07/02/2019: [Text](https://aldosolari.github.io/DM/exams/DM070219/DM070219_text.pdf) - [Solution](https://aldosolari.github.io/DM/exams/DM070219/DM070219_solution.html) - [Marks](https://aldosolari.github.io/DM/exams/DM070219/DM070219_esiti.pdf)


* 22/02/2019: [Text](https://aldosolari.github.io/DM/exams/DM220219/DM220219_text.pdf) - [Solution](https://aldosolari.github.io/DM/exams/DM220219/DM220219_solution.html) - [Marks](https://aldosolari.github.io/DM/exams/DM220219/DM220219_esiti.pdf)

* 05/07/2019: [Marks](exams/DM050719/DM050719_esiti.pdf)

* 16/07/2019: [Marks](exams/DM160719/DM160719_esiti.pdf)

* 18/09/2019: [Marks](exams/DM180919/DM180919_esiti.pdf)
...
* [Statistics 36-462/36-662: Data Mining](http://www.stat.cmu.edu/~ryantibs/datamining/)
* [Applied Machine Learning](https://github.com/topepo/NY-ML-2018)
