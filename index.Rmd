...
* October 15: Competitions [registration](https://docs.google.com/forms/d/e/1FAIpQLSfeMNn7uHbZaxPVWduLYdN0dgEm_EnbjjVaPH1SV7VXwF_lTw/viewform?usp=pp_url), 1st round (October-November)
...
- [Rosset and Tibshirani (2018) From Fixed-X to Random-X Regression](https://arxiv.org/pdf/1704.08160.pdf)
...
| OkCupid  | 16/10/18 - 16/11/18 | ?/1/19 - ?/1/19 | ?/6/19 - ?/6/19  |
| Bikeshare | 16/10/18 - 16/11/18 | ?/1/19 - ?/1/19  | ?/6/19 - ?/6/19  |
...
* you are encouraged to use online resources (unseen models, other people analyses, etc.) as long as you __cite__ a resource you borrow code from
