...
2. The covariates $x^*_1,\ldots,x^*_n$ used for prediction exactly match $x_1,\ldots,x_n$, respectively, and the
corresponding responses $y^*_1,\ldots,y^*_n$ are independent copies of $y_1,\ldots,y_n$, respectively.
...
ErrFs = Bias2s+Vars
barplot(ErrFs, ylab="ErrF", names.arg=ps)
