...
predictor vector $X\in \mathbb{R}^p$, based on training data comprised of paired observations $(x_1,y_1),\ldots,(x_n,y_n)$ i.i.d. from $(X,Y)$.
...
where $f(x)=\mathbb{E}(Y|x)$ is the unknown regression function, 
