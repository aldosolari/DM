...
where $\varepsilon$ is an error component with distribution $N(0,\sigma^2)$ and $\sigma=10^{-2}$; $f$ is a function which we leave unspecified, the only requirement is that this function should follow an essentially regular trend.
