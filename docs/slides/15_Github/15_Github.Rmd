...
* At this point I'm assuming you have produced HTML files with Rmarkdown containing the description of the analysis and the code used in the last submission

* Here is an [example](docs/competitions/publish_example.html)
