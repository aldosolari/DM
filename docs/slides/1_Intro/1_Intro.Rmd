...
* **House prices** (30%) Individual competition

* **OkCupid** (40%) Individual/Team

* **BikeSharing** (30%) Individual/Team

* There are 3 rounds (time windows) per academic year in which you can join the competitions and submit your predictions

* You can join the competitions __only once__ per academic year. The score will expire at the end of the academic year


| Competition | Problem | 1st: From-To | 2nd: From-To | 3rd: From-To | 
|----|----|----|----|----|
| [Houses prices](docs/competitions/Houseprices/Houseprices.html) | Regression | 8/10/18 - 16/11/18 | ?/1/19 - ?/1/19 | ?/6/19 - ?/6/19  |
| [OkCupid](docs/competitions/OkCupid/OkCupid.html) | Classification | 16/10/18 - 16/11/18 | ?/1/19 - ?/1/19 | ?/6/19 - ?/6/19  |
| [Bikesharing](docs/competitions/Bikesharing/Bikesharing.html) | Regression | 16/10/18 - 16/11/18 | ?/1/19 - ?/1/19  | ?/6/19 - ?/6/19  |
...
knitr::include_graphics("images/magazines.jpg")
```
