...
[\mathbb{E}\hat{f}(x_i) - f(x_i) ]^2 + \mathbb{V}\mathrm{ar}[\hat{f}(x_i)] = \mathrm{Bias2+Variance}$$

* Now the decomposition of fixed-X prediction error is simply
$$\mathrm{ErrF} =  \sigma^2 + \frac{1}{n}\sum_{i=1}^{n}(\mathbb{E}(\hat{f}(x_i) - f(x_i)) )^2 + \frac{1}{n}\sum_{i=1}^{n} \mathbb{V}\mathrm{ar}(\hat{f}(x_i))$$
...
knitr::include_graphics("http://www-bcf.usc.edu/~gareth/ISL/Chapter2/2.9.pdf")
```
...
```{r, echo=FALSE, fig.align = 'center', out.width = '80%', out.height = '80%'}
knitr::include_graphics("http://www-bcf.usc.edu/~gareth/ISL/Chapter2/2.10.pdf")
```
...
```{r, echo=FALSE, fig.align = 'center', out.width = '80%', out.height = '80%'}
knitr::include_graphics("http://www-bcf.usc.edu/~gareth/ISL/Chapter2/2.11.pdf")
```
...
```{r, echo=FALSE, fig.align = 'center', out.width = '80%', out.height = '80%'}
knitr::include_graphics("http://www-bcf.usc.edu/~gareth/ISL/Chapter2/2.12.pdf")
```
