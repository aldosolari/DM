...
* The null model predicts 'all-dead'
...
A classification tree recursively partitions the sample space into smaller and smaller rectangles
...
Classification tree decision rule
