...
* Si vuole individuare una stima di $f(x)$ che ci consenta di predire i nuovi dati che ci arriveranno domani, i dati di verifica, prodotti dallo stesso meccanismo generatore
...
* Consideriamo il modello di regressione polinomiale di grado $d$
