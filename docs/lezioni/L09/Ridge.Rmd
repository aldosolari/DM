...
Ciascuna osservazione corrisponde ad una corsa in taxi nella città di New York nel mese di Maggio 2015. 

La variabile risposta è la percentuale di mancia lasciata al tassista (`tip_perc`). 

```{r}
# importazione dei dati
PATH <- "https://raw.githubusercontent.com/aldosolari/DM/master/docs/lezioni/L09/"
taxi <- read.csv(paste(PATH,"taxi.csv"))
head(taxi)
```
