...
**Spiegare** qual è il problema e dove avviene l'errore (anche in termini di codice R). **Cosa vi aspettate** di ottenere (in termini di valori previsti $\hat{y}^*_i$) se utilizzate il polinomio di grado $n-1$? Si giustifichi la risposta. 
