...
**Suggerire** possibili soluzioni (in termini di codice R) per ottenere le stime dei coefficienti del modello con $d=28$ (riportare le stime dei coefficienti senza arrotondare i valori). 
